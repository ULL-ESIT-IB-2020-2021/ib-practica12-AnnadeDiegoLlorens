 ...
 * @date 10/01/2021
 * @brief libreria que contiene las funciones para operar con vectores
 * 
*/

#ifndef COMPLEJOS_FUNCIONES_H
#define COMPLEJOS_FUNCIONES_H

Complejo suma(Complejo complejo1, Complejo complejo2);
Complejo suma(Complejo complejo,double real);
Complejo suma(Complejo complejo,int entero);
